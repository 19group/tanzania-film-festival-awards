// Translations for the Tanzania Film Festival Award 2025 website
export const languages = ["en", "sw"];
export const defaultLanguage = "en";
export const defaultTranslations = translations[defaultLanguage];
// Translations object containing all text for the website
export const getTranslations = (lang) => {
    if (!languages.includes(lang)) {
        console.warn(`Language ${lang} not supported, falling back to default language.`);
